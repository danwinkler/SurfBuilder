...
public class Faces extends PRenderer
{
	...
	public ArrayList<Triangle> buildTris()
	{
		...
		Field f = fb.buildField( primitives, new Vector3f( -10, -10, -3 ), new Vector3f( 10, 10, 13 ), .5f );
