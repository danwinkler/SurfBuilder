...
public class SurfBuilder 
{
	public static void main( String[] args )
	{
		...
		solver.addPrimitive( new Preset.InvExpLine( p0, p1, dm ) );
		solver.addPrimitive( new Preset.InvExpLine( p0, p2, dm ) );
		solver.addPrimitive( new Preset.InvExpLine( p0, p3, dm ) );
